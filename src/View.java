...
public class View {
     ...
     * columns: episodes 
     *
     * @see Assignment2::firstMust()
     */
    public static void episodeMatrixToMatlabScript(String filename, double episodesMatrix[][], double paramValues[], String paramName, String yLabel, int yMinMaxValues[]) {
