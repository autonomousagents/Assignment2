...
Figure \ref{plot:Qalphagamma} shows plots on the performance of the agent over time for different $\alpha$ and for different $\gamma$ (discount factor).

\begin{figure}
\label{plot:Qalphagamma}
% plots hier!!!!
\end{figure}
